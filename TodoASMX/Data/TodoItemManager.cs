...
namespace TodoASMX
{
	public class TodoItemManager
	{
		...
		public Task<SoapResult<List<TodoItem>>> GetTodoItemsAsync ()
		{
			return soapService.RefreshDataAsync ();
		}

		public Task<SoapResult<bool>> SaveTodoItemAsync (TodoItem item, bool isNewItem = false)
		{
			return soapService.SaveTodoItemAsync (item, isNewItem);
		}

		public Task<SoapResult<bool>> DeleteTodoItemAsync (TodoItem item)
		{
